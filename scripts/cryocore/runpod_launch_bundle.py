...
echo \"Prepared CryoCore RunPod launch manifest: $MANIFEST\"
echo \"Next manual step after approval: create a RunPod Pod from runpod/templates/*.template.json\"
echo \"Then run the audit, toolcheck, and final self-check against /workspace/cryocore/runs/{manifest['run_id']}\"
"""
